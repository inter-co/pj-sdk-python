...
class RetrieveImmediateBillingsFilter:
    ...
    @staticmethod
    def from_dict(data: dict) -> 'RetrieveImmediateBillingsFilter':
        """
        Create a RetrieveImmediateBillingsFilter instance from a dictionary.

        Args:
            data (dict): A dictionary containing the RetrieveImmediateBillingsFilter data.

        Returns:
            RetrieveImmediateBillingsFilter: An instance of RetrieveImmediateBillingsFilter.
        """
        return RetrieveImmediateBillingsFilter(
            cpf=data.get("cpf"),
            cnpj=data.get("cnpj"),
    ...
    def to_dict(self) -> dict:
        """
        Convert the RetrieveImmediateBillingsFilter instance to a dictionary.

        Returns:
            dict: A dictionary representation of the RetrieveImmediateBillingsFilter instance.
        """
        return {
            "cpf": self.cpf,
            "cnpj": self.cnpj,
